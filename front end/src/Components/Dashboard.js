...
class Dashboard extends Component  {
    ...
    constructor(){
        ...
        axios.post("http://ec2-54-224-252-110.compute-1.amazonaws.com:8082/pensionerDetailByAadhaar/"+aadhar).then((res) => {
    ...
    handleSubmit(event){
        ...
        axios.post("http://ec2-54-224-252-110.compute-1.amazonaws.com:8083/disbursePension",data).then((ver)=>{
            this.setState({
